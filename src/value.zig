...
pub const Value = extern union {
    ...
    pub fn copy(self: Value, allocator: *Allocator) error{OutOfMemory}!Value {
        if (self.tag_if_small_enough < Tag.no_payload_count) {
            ...
            .extern_function => return self.copyPayloadShallow(allocator, Payload.ExternFunction),
    ...
    pub fn format(
        ...
        while (true) switch (val.tag()) {
            ...
            .extern_function => return out_stream.writeAll("(extern function)"),
    ...
    pub fn hash(self: Value) u64 {
        ...
        switch (self.tag()) {
            ...
            .extern_function => {
                const payload = @fieldParentPtr(Payload.ExternFunction, "base", self.ptr_otherwise);
                std.hash.autoHash(&hasher, payload.func);
            },
            .variable => {
    ...
    pub const Payload = struct {
        ...
        pub const ExternFunction = struct {
            base: Payload = Payload{ .tag = .extern_function },
            func: *Module.ExternFn,
        };
